...
export function FestiveDecor() {
  return (
    <>
      <span className="pointer-events-none fixed left-2 top-24 z-10 text-3xl text-pink-100/80">梅</span>
      <span className="pointer-events-none fixed bottom-24 right-2 z-10 text-3xl text-pink-100/80">花</span>
      <div className="pointer-events-none fixed left-0 right-0 top-0 z-30 flex items-start justify-between px-4 py-2 md:px-10">
        ...
        <span className="rounded-lg border border-yellow-300/60 bg-red-900/70 px-3 py-1 text-lg text-yellow-200">福到好运到</span>
        <span className="text-4xl text-yellow-300 drop-shadow">🏮</span>
      </div>
